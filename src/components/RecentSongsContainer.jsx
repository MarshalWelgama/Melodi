...
class RecentSongsContainer extends Component {
    ...
    getRecentDetails = async () => {
        let RecentCommentData = await axios.get("http://localhost:8888/api/comments/recent");
    ...
    return ( commentData.length ? <RecentBox name={'Recently Talked About'}data={commentData}></RecentBox> : <React.Fragment>
