...
class TopCommentsContainer extends Component {
    ...
    getRecentDetails = async () => {
        let RecentCommentData = await axios.get("http://localhost:8888/api/comments/Top");
    ...
    return ( commentData.length ? <RecentBox name={'Top Comments'}data={commentData}></RecentBox> : <React.Fragment>
